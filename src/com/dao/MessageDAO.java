...
public class MessageDAO extends HibernateDaoSupport {
	...
	public static final String MESAGE_MAIL = "mesageMail";
	...
	public List findByMesageMail(Object mesageMail) {
		return findByProperty(MESAGE_MAIL, mesageMail);
	}
