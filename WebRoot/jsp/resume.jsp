...
<body style="text-align: center;">
	...
	<div class="container-fluid-2" style="margin:0 auto; height:auto;width:auto; max-width: 1076px;max-height: 1798px;text-align:center;">
		<img src="${pageContext.request.contextPath}/img/jianli.jpg" alt="个人简历" title="点击图片下载简历" onclick='window.open("${pageContext.request.contextPath}/res/resume-Tan.docx")' style="width:100%;max-width: 1076px; height: auto; display: block; vertical-align:middle;text-align: center;"/>
	</div>
	</section>
